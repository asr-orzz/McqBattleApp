...
export default function GameLobbyPage() {
  ...
  const checkGameStatusAndLoad = async () => {
    try {
      ...
      const statusResponse = await fetch(`https://mcqbattleapp-production.up.railway.app/api/v1/games/${gameId}/status`)
  ...
  const fetchFirstQuestion = async () => {
    try {
      ...
      const response = await axios.post(
        `https://mcqbattleapp-production.up.railway.app/api/v1/players/first-question?gameId=${gameId}`,
        {}, // Empty body
        {
          headers: {
  ...
  const submitAnswer = async (optionId: string) => {
    ...
    try {
      ...
      const response = await fetch("https://mcqbattleapp-production.up.railway.app/api/v1/players/player-answer", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const startGame = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://mcqbattleapp-production.up.railway.app/api/v1/games/${gameId}/start`, {
        method: "PATCH",
        headers: {
          Authorization: token,
          "Content-Type": "application/json",
  ...
  const leaveGame = async () => {
    try {
      ...
      const response = await fetch("https://mcqbattleapp-production.up.railway.app/api/players/player-leave", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
